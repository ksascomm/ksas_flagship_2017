...
function wpt_register_theme_customizer( $wp_customize ) {
		...
		'priority'       => 1000,
		'theme_supports' => '',
		'title'          => __( 'Mobile Menu Settings', 'ksasflagship' ),
		'description'    => __( 'Controls the mobile menu', 'ksasflagship' ),
		) );

		// Create custom field for mobile navigation layout
		$wp_customize->add_section( 'mobile_menu_layout' , array(
			'title'    => __('Mobile navigation layout','ksasflagship'),
		...
		$wp_customize->add_setting(
			...
			array(
			'default' => __( 'topbar', 'ksasflagship' ),
