...
/**
 * Desktop navigation - search bar lniks
 *
 * @link http://codex.wordpress.org/Function_Reference/wp_nav_menu
 */
if ( ! function_exists( 'foundationpress_search_links' ) ) {
	function foundationpress_search_links() {
		wp_nav_menu( array(
			'container'      => false,
			'menu_class'     => 'menu simple hide-for-small-only',
			'items_wrap'     => '<ul id="%1$s" class="%2$s desktop-menu" data-dropdown-menu>%3$s</ul>',
