				    ...
				    <div class="row">
				        <div class="small-12 large-push-1 columns">
				          <h1>Application Deadline</h1>
				          	<p>Applications for prospective undergraduate students wishing to start in fall 2018 are due Jan. 3.</p>
				          	<p><a class="button orbit" href="https://apply.jhu.edu/" target="_blank">Apply Now</a></p>
				         </div>
				     </div>
				</figcaption>
			</li>
	...
	<div class="front-hero hide-for-large"></div>
		<div class="row hide-for-large">
	        <div class="small-12 large-push-1 columns">
	          <h1>Application Deadline</h1>
	          	<p>Applications for prospective undergraduate students wishing to start in fall 2018 are due Jan. 3.</p>
	          	<p><a class="button orbit" href="https://apply.jhu.edu/">Apply Now</a></p>
	         </div>
	         <hr>
	     </div>
